...
export default function InteractiveIcon() {
  ...
  return (
    <div className="no-tap-highlight group relative flex size-[300px] cursor-pointer select-none items-center justify-center text-content mix-blend-multiply duration-300 hover:text-[#51B660]">
