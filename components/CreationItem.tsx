...
export default function CreationItem({
  ...
  return (
    <Link
      ...
      className="group relative flex min-w-64 max-w-full cursor-none flex-col place-items-center gap-0 overflow-hidden border border-dashed border-neutral-400 px-20 py-10 transition-all duration-500 hover:z-50 hover:bg-primary hover:duration-80"
