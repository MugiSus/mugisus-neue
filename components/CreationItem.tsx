...
export default function CreationItem({
  ...
  return (
    <Link
      ...
      className="group relative flex max-w-full cursor-none flex-col place-items-center gap-0 overflow-x-clip border-neutral-400 px-20 py-10 transition-all duration-500 hover:z-50 hover:bg-primary hover:duration-80"
      onMouseMove={subtle3dEffect}
      onMouseLeave={abort3dEffect}
    >
      <div
        className="absolute left-0 top-6 flex animate-marquee-left select-none gap-0 whitespace-nowrap text-7xl font-thin leading-none -tracking-widest text-background duration-500 group-hover:duration-80"
        style={{
