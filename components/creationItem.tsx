...
export default function CreationItem({
  ...
  const content = (
    ...
    >
      ...
      <FontAwesomeIcon
        icon={faArrowRight}
        className="opacity-0 absolute h-5 right-5 top-0 bottom-0 m-auto text-stone-600 duration-300 group-hover:opacity-100 transition-all group-hover:translate-x-1"
      />
    </li>
  );
